...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            for (let i = 0; i < 1; i++) {
                var templateString = '<div class="LoginForm1"  id="pls' + i + '"><div class="container"><h4><b>' + data.plane_nr + '</b></h4> <h3><b>' + price + '</b></h3> <h3><b>' + data.from + '</b></h3> <h3><b>' + data.to + '</b></h3> <p>' + data.departure_date + '</p> <p>Arrival</p> <p>' + data.arrival_date + '</p></div></div><br>';
            ...
            // data = JSON.parse(data)
            // for (let i = 0; i < 1; i++) {
            //     var templateString = '<div class="LoginForm1"  id="pls' + i + '"><div class="container"><h4><b>' + data.plane_nr + '</b></h4> <h3><b>' + data.from + '</b></h3> <h3><b>' + data.to + '</b></h3> <p>' + data.departure_date + '</p> <p>Arrival</p> <p>' + data.arrival_date + '</p></div></div><br>';
