...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            for (let i = 0; i < data.length; i++) {
                var templateString = '<div class="LoginForm1"  id="pls' + i + '"><div class="container2"><h3>' + data[i].plane_nr + '</h3> <h3>' + "From :" + "  " + data[i].from + '</h3> <h3>' + "To :" + "  " + data[i].to + '</h3> <h3>' + "Departure :" + "  " + data[i].departure_date + '</h3> <h3>' + "Arrival :" + "  " + data[i].arrival_date + '</h3></div><br>';
